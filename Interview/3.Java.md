...
11. 什么时候用接口，什么时候用抽象类
    ...
    - 接口的方法需要全部实现，抽象类中的非抽象方法可以继承而无需重写
...
14. 泛型中extends和super的区别
    ...
    - 上界 `<? extend Fruit>`，下界  `<? super Apple>`
    - 上界的list只能get，不能add，确切的说不能add除了null以外的所有对象，包括object
    - 
...
19. Serializable 和Parcelable 的区别
...
7. 如果年轻代经常发生gc，会是什么原因，怎么解决

8. 项目上如果发生了oom如何定位问题

9. 如何调整新老年代的空间，项目上是怎么设计的，你们生产的比例一般设为多少

10. 年轻代经常gc，可以调高年轻代的空间吗，这样做的优缺点是什么
...
15. redis怎么实现分布式锁的，实现的原理

16. mysql 索引结构，聚簇索引和非聚簇索引的区别

17. `select a from table where b=15 order by c`，应该怎么建索引

18. 项目上遇到什么难题，怎么解决

19. 说一下你项目上的合同这个模块的背景（我说我做的大多都是合同系统），怎么操作的，给谁用，具体流程是什么
